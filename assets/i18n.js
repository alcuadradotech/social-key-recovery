...
;(function(root, factory) {
    ...
    const i18n = {
        ...
        es: {
            ...
            desc: "Esta herramienta transfórma tu secreto en una serie de claves que puedes <b>repartir</b> entre las personas o los lugares con los que siempre puedes contar. <b>Recupera</b> tu secreto juntando claves repartidas.<br/><br/>Es ideal para asegurar tu <b>clave privada blockchain</b>!",
            home: "Inicio",
            share: "Repartir",
            shareSecretsDesc: "Transforma tu secreto en tantas claves como quieras y establece cuántas de ellas serán requeridas para recuperar tu secreto.",
            recover: "Recuperar",
            recoverSecretsDesc: "Introduce la cantidad de claves requeridas para recuperar tu secreto e introduce cada una de ellas.",
